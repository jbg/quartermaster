...
pub struct ApiConfig {
    ...
    pub ai_pantry_suggestion_max_output_tokens: u32,
...
#[openapi(
    ...
    paths(
        ...
        routes::pantry::create_suggestions,
        ...
        routes::label_printers::render_test_label_printer,
        routes::units::list_units,
        routes::households::get_current_household,
        routes::households::update_current_household,
        routes::households::export_current_household,
        routes::households::request_current_household_deletion,
        ...
        routes::ingredients::create,
        routes::ingredients::get_one,
        routes::ingredients::update,
        routes::ingredients::delete_one,
        routes::ingredients::create_mapping,
        routes::ingredients::delete_mapping,
        routes::ingredients::availability,
        routes::ingredients::get_product_metadata,
        routes::ingredients::put_product_metadata,
        routes::recipes::list,
        routes::recipes::create,
        routes::recipes::import_text,
        routes::recipes::get_one,
        routes::recipes::update,
        routes::recipes::delete_one,
        routes::recipes::scale,
        routes::recipes::validate,
        routes::recipes::preflight,
        routes::recipes::execute,
        routes::replenishment::list_rules,
        routes::replenishment::create_rule,
        routes::replenishment::get_rule,
        routes::replenishment::update_rule,
        routes::replenishment::delete_rule,
        routes::replenishment::pause_rule,
        routes::replenishment::resume_rule,
        routes::replenishment::get_settings,
        routes::replenishment::put_settings,
        routes::replenishment::get_supplier_policy,
        routes::replenishment::put_supplier_policy,
        routes::replenishment::list_demand_signals,
        routes::replenishment::create_demand_signal,
        routes::replenishment::patch_demand_signal,
        routes::replenishment::create_cart_draft,
        routes::replenishment::get_cart_run,
        ...
        routes::products::off_contribution_preview,
        routes::products::off_contribution,
        ...
        routes::label_printers::render_stock_label,
    ),
    components(schemas(
        qm_core::units::UnitFamily,
        qm_core::units::MeasurementSystem,
        types::ProductSource,
        types::IngredientMatchKind,
        types::ConversionProvenance,
        types::RecipeSource,
        ...
        routes::pantry::CreatePantrySuggestionsRequest,
        routes::pantry::PantrySuggestionsResponse,
        routes::pantry::PantrySuggestionListResponse,
        routes::pantry::PantryContextDto,
        routes::pantry::PantryInventoryItemDto,
        routes::pantry::PantryInventoryBatchDto,
        routes::pantry::PantryExpiryUrgency,
        routes::pantry::PantrySuggestionDto,
        routes::pantry::PantrySuggestionScoreDto,
        ...
        routes::households::DeleteHouseholdRequest,
        routes::households::DeleteHouseholdResponse,
        qm_db::household_exports::HouseholdExportDocument,
        qm_db::household_exports::ExportHousehold,
        qm_db::household_exports::ExportLocation,
        qm_db::household_exports::ExportStorageVessel,
        qm_db::household_exports::ExportLabelPrinter,
        qm_db::household_exports::ExportProduct,
        qm_db::household_exports::ExportIngredient,
        qm_db::household_exports::ExportIngredientProductMapping,
        qm_db::household_exports::ExportProductRecipeMetadata,
        qm_db::household_exports::ExportRecipe,
        qm_db::household_exports::ExportRecipeVersion,
        qm_db::household_exports::ExportRecipeIngredient,
        qm_db::household_exports::ExportRecipeStep,
        qm_db::household_exports::ExportRecipeOutput,
        qm_db::household_exports::ExportRecipeProvenance,
        qm_db::household_exports::ExportBarcodeCacheEntry,
        qm_db::household_exports::ExportStockBatch,
        qm_db::household_exports::ExportStockEvent,
        qm_db::household_exports::ExportStockReminder,
        ...
        routes::label_printers::RenderLabelResponse,
        ...
        routes::products::OffContributionFieldChange,
        routes::products::OffContributionPreviewResponse,
        routes::products::OffContributionResponse,
        routes::ingredients::IngredientDto,
        routes::ingredients::IngredientListResponse,
        routes::ingredients::IngredientProductMappingDto,
        routes::ingredients::IngredientProductConversionDto,
        routes::ingredients::StructuredQuantityDto,
        routes::ingredients::QuantityRangeDto,
        routes::ingredients::CreateIngredientRequest,
        routes::ingredients::CreateIngredientProductMappingRequest,
        routes::ingredients::IngredientAvailabilityResponse,
        routes::ingredients::IngredientAvailabilityDto,
        routes::ingredients::ProductRecipeMetadataDto,
        routes::recipes::RecipeListResponse,
        routes::recipes::RecipeSummaryDto,
        routes::recipes::RecipeDto,
        routes::recipes::RecipeVersionDto,
        routes::recipes::RecipeIngredientDto,
        routes::recipes::RecipeStepDto,
        routes::recipes::RecipeTimerDto,
        routes::recipes::RecipeOutputDto,
        routes::recipes::RecipeProvenanceDto,
        routes::recipes::CreateRecipeRequest,
        routes::recipes::ImportTextRecipeRequest,
        routes::recipes::ScaleRecipeRequest,
        routes::recipes::RecipeScaleResponse,
        routes::recipes::ScaledRecipeIngredientDto,
        routes::recipes::ScaledRecipeOutputDto,
        routes::recipes::RecipeValidationResponse,
        routes::recipes::RecipeValidationIssueDto,
        routes::recipes::RecipeExecutionIngredientRequest,
        routes::recipes::RecipeExecutionOutputRequest,
        routes::recipes::RecipeExecutionRequest,
        routes::recipes::RecipeExecutionPreflightResponse,
        routes::recipes::RecipeIngredientPlanDto,
        routes::recipes::RecipeMatchedBatchDto,
        routes::recipes::RecipeMissingIngredientDto,
        routes::recipes::RecipeOutputPreviewDto,
        routes::recipes::RecipeExecutionResponse,
        routes::replenishment::ReplenishmentAutomationLevelDto,
        routes::replenishment::ReplenishmentCartRunDto,
        routes::replenishment::ReplenishmentCartRunStatusDto,
        routes::replenishment::ReplenishmentCreateCartDraftRequest,
        routes::replenishment::ReplenishmentCreateCartDraftResponse,
        routes::replenishment::ReplenishmentDemandSignalDto,
        routes::replenishment::ReplenishmentDemandSignalListResponse,
        routes::replenishment::ReplenishmentDemandSignalRequest,
        routes::replenishment::ReplenishmentDemandSignalStatusDto,
        routes::replenishment::ReplenishmentDemandSignalTypeDto,
        routes::replenishment::ReplenishmentGuardrailDecisionDto,
        routes::replenishment::ReplenishmentPatchDemandSignalRequest,
        routes::replenishment::ReplenishmentPauseRuleRequest,
        routes::replenishment::ReplenishmentRuleDto,
        routes::replenishment::ReplenishmentRuleListResponse,
        routes::replenishment::ReplenishmentRuleRequest,
        routes::replenishment::ReplenishmentSettingsDto,
        routes::replenishment::ReplenishmentSettingsRequest,
        routes::replenishment::ReplenishmentSupplierPolicyDto,
        routes::replenishment::ReplenishmentSupplierPolicyRequest,
        routes::replenishment::ReplenishmentSuppressionReasonDto,
        ...
        routes::stock::SplitStockRemainderRequest,
        routes::stock::SplitStockRequest,
        routes::stock::SplitStockResponse,
    ...
    tags(
        ...
        (name = "storage-vessels", description = "Household reusable tare profiles"),
        ...
        (name = "ingredients", description = "Recipe ingredients, product mappings, and recipe-layer conversion metadata"),
        (name = "recipes", description = "Household-scoped reusable recipes, versions, validation, and scaling"),
        (name = "replenishment", description = "Replenishment rules, demand signals, cart generation, and automation guardrails"),
...
pub fn router(state: AppState) -> Router {
    ...
    let api_routes = Router::new()
        ...
        .merge(routes::replenishment::router())
