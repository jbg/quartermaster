...
internal object SmokeTag {
    ...
    const val CookScreen = "smoke-cook-screen"
    const val CookEntryInventory = "smoke-cook-entry-inventory"
    const val CookEntrySettings = "smoke-cook-entry-settings"
    const val RecipePreflightExecute = "recipe.preflight.execute"
    const val CartGenerate = "cart.generate"
    const val CartSubmit = "cart.submit"
    const val CartReceive = "cart.receive"
    ...
    fun recipeRow(id: String) = "recipe.row.$id"
    fun recipePreflightRow(id: String) = "recipe.preflight.row.$id"
    fun recipeMissingRow(id: String) = "recipe.missing.row.$id"
    fun cartRow(id: String) = "cart.row.$id"
