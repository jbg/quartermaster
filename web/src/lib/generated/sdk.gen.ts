...
export const stockConsumeAndStore = <ThrowOnError extends boolean = false>(options: Options<StockConsumeAndStoreData, ThrowOnError>) => (options.client ?? client).post<StockConsumeAndStoreResponses, StockConsumeAndStoreErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
